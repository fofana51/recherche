...
<!-- Mirrored from prium.github.io/elixir/v3.0.0/pages/blank.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 17:51:55 GMT -->
        ...
        <nav class="navbar navbar-expand-lg"> <a class="navbar-brand" href="index-2.html"><img src="../assets/img/log.png" alt="logo" />Baoré</a><button class="navbar-toggler p-0" type="button" data-bs-toggle="collapse" data-bs-target="#primaryNavbarCollapse" aria-controls="primaryNavbarCollapse" aria-expanded="false" aria-label="Toggle navigation"><span class="hamburger hamburger--emphatic"><span class="hamburger-box"><span class="hamburger-inner"></span></span></span></button>
          <div class="collapse navbar-collapse" id="primaryNavbarCollapse">
            <ul class="navbar-nav py-3 py-lg-0 mt-1 mb-2 my-lg-0 ms-lg-n1">
              ...
              <li class="nav-item dropdown"><a class="nav-link" href="actualités.html" role="button">Actualités</a></li>
              </li>
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle dropdown-indicator" href="JavaScript:void(0)" role="button" data-bs-toggle="dropdown" aria-expanded="false">Domaines</a>
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item" href="pages/science.html">Sciences de la Santé</a></li>
        ...
        <footer class="footer bg-primary text-center py-4">
          <div class="container">
            <div class="row align-items-center opacity-85 text-white">
              <div class="col-sm-3 text-sm-start"><a href="index-2.html"><img src="../assets/img/log.png" alt="logo" /></a></div>
