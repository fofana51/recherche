...
<!-- Mirrored from prium.github.io/elixir/v3.0.0/news/newsroom.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 17:52:01 GMT -->
            ...
            <ul class="navbar-nav py-3 py-lg-0 mt-1 mb-2 my-lg-0 ms-lg-n1">
              ...
              <li class="nav-item dropdown"><a class="nav-link dropdown-toggle dropdown-indicator" href="JavaScript:void(0)" role="button" data-bs-toggle="dropdown" aria-expanded="false">News</a>
                <ul class="dropdown-menu">
                  ...
                  <li><a class="dropdown-item" href="news.html">Single News</a></li>
                </ul>
              </li>
        ...
        <div class="container">
          <div class="row g-4">
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news.html"><img class="card-img-top" src="../assets/img/9.jpg" alt="Featured Image" /></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  ...
                  <div class="overflow-hidden">
                    <div class="d-inline-block" data-zanim-xs='{"delay":0.3}'><a class="d-flex align-items-center" href="news.html">Learn More<div class="overflow-hidden ms-2" data-zanim-xs='{"from":{"opacity":0,"x":-30},"to":{"opacity":1,"x":0},"delay":0.8}'><span class="d-inline-block fw-medium">&xrarr;</span></div></a></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news.html"><img class="card-img-top" src="../assets/img/10.jpg" alt="Featured Image" /></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  <div class="overflow-hidden"><a href="news.html">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news.html"><img class="card-img-top" src="../assets/img/11.jpg" alt="Featured Image" /></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  <div class="overflow-hidden"><a href="news.html">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news.html"><img class="card-img-top" src="../assets/img/12.jpg" alt="Featured Image" /></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  <div class="overflow-hidden"><a href="news.html">
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news.html"><img class="card-img-top" src="../assets/img/13.jpg" alt="Featured Image" /></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  <div class="overflow-hidden"><a href="news.html">
                      <h5 data-zanim-xs='{"delay":0}'>What brexit means for data protection law</h5>
                    </a></div>
            ...
            <div class="col-md-6 col-lg-4">
              <div class="card"><a href="news.html"><img class="card-img-top" src="../assets/img/14.jpg" alt="Featured Image" /></a>
                <div class="card-body" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                  <div class="overflow-hidden"><a href="news.html">
                      <h5 data-zanim-xs='{"delay":0}'>The growing meanace of social engineering fraud</h5>
                    </a></div>
    ...
    <footer class="footer bg-primary text-center py-4">
      <div class="container">
        <div class="row align-items-center opacity-85 text-white">
          <div class="col-sm-3 text-sm-start"><a href="../index-2.html"><img src="../assets/img/logo-light.png" alt="logo" /></a></div>
...
<!-- Mirrored from prium.github.io/elixir/v3.0.0/news/newsroom.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 17:52:10 GMT -->
</html>