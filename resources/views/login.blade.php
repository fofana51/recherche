...
<!-- Mirrored from prium.github.io/elixir/v3.0.0/pages/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Aug 2022 17:51:56 GMT -->
                    ...
                    <div class="row align-items-center">
                      <div class="col-12">
                        <div class="input-group">
                          <div class="input-group-text bg-100"><span class="far fa-user"></span></div><input class="form-control" type="text" placeholder="Email " aria-label="Text input with dropdown button" />
                        </div>
                      </div>
                      <div class="col-12 mt-2 mt-sm-4">
                        <div class="input-group">
                          <div class="input-group-text bg-100"><span class="fas fa-lock"></span></div><input class="form-control" type="Password" placeholder="Mot De Passe" aria-label="Text input with dropdown button" />
                        </div>
                      </div>
                    </div>
...
<li><a class="dropdown-item" href="pages/login.html">Se connecter </a></li>
              <li><a class="dropdown-item" href="pages/registration.html">s'inscrire</a></li>